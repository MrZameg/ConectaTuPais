...
class InstitutionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create institution" do
    assert_difference('Institution.count') do
      post institutions_url, params: { institution: { description: @institution.description, name: @institution.name, phone: @institution.phone, web: @institution.web } }
    end
  ...
  test "should update institution" do
    patch institution_url(@institution), params: { institution: { description: @institution.description, name: @institution.name, phone: @institution.phone, web: @institution.web } }
